...
JMR: Yes, there is no need to specify new items that are automatically generated by the transducer.
The NDS, however, can utilize the work that MR has done; it makes for a more interesting dictionary.

DONE 3. grep says that there are pos="Ger" in the adv-file, too.
...
DONE JMR Has moved pos="Ger" entries to V_Ger_sms2x.xml
